# ciab-oneclick
A one-click script that installs a remote desktop environment on a Linux server with browser/RDP access.
...
```
wget https://raw.githubusercontent.com/bmullan/ciab-oneclick.sh && sudo bash ciab-oneclick.sh
```
...
* Please consider reporting the error log at https://github.com/Har-Kuun/OneClickDesktop/iO issues so that I can fix any underlying issues.
