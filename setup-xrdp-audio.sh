...
#==========================================================================================
# add-audio-to-xrdp.sh
#
#    PURPOSE:
#    reconfigures xRDP to support Audio Redirection for ciab-oneclick                                     
#
#    Thanks c-energy for providing detailed instructions on pulseaudio setup.    
#
#          https://c-nergy.be/blog/?p=16817
#
#==========================================================================================
 
exec > >(tee -i ciab-oneclick-xrdp-audio-upgrade.log)
exec 2>&1
...
#==========================================================================================
#
function check-ciab-oneclick-installation
{
...
function main
{
	...
	say @B"You must have 'ciab-oneclick' installed in xrdp mode on your Host/Server before running this script." yellow
	echo 
	...
	if [ "x$confirm_installation" = "xY" ] || [ "x$confirm_installation" = "xy" ] ; then
		check_ciab-oneclick_installation
		CurrentDir=$(pwd)
		if [ "$OS" = "DEBIAN10" ] ; then
